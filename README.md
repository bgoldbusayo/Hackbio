...
Prevent users from exploring alternative thresholds or parameters

Hide metadata such as sample identity or experimental conditions

Make it difficult for collaborators or clinicians to ask follow-up questions
...
Filter samples dynamically

Adjust thresholds (e.g., fold change, p-values)

Explore multiple views of the same dataset

Link plots to tables and annotations
